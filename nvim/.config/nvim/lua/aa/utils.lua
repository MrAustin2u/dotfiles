...
utils.lsp.on_attach = function(client, bufnr)
	...
	aa.lua_command("LspDiagLine", "vim.diagnostic.open_float(nil, require('aa.utils').border_opts)")
	aa.lua_command("LspDiagPrev", "vim.diagnostic.goto_prev()")
	aa.lua_command("LspDiagNext", "vim.diagnostic.goto_next()")
