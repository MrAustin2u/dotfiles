...
- **[dotfiles-reviewer](dotfiles-reviewer.md)** - Expert review of dotfiles configurations, shell scripts, and development environment setup
- **[neovim-lua-expert](neovim-lua-expert.md)** - Neovim configuration, Lua scripting, plugin management, and LSP setup
...
- `dotfiles-reviewer` - Dotfiles and shell configuration review
- `neovim-lua-expert` - Neovim configuration and Lua scripting
...
- **dotfiles-reviewer**: Shell configurations, development environment setup, dotfile best practices
- **neovim-lua-expert**: Neovim configuration, Lua scripting, plugin management, LSP setup
